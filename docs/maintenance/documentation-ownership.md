...
| Shipped graph configurations | `docs/graphs/graphs-index.md` | `docs/graphs/execution-standard.md`, `docs/graphs/execution-with-integrator.md`, `docs/graphs/planning-standard.md`, `docs/graphs/planning-blueprint.md`, `docs/graphs/learning-standard.md` |
