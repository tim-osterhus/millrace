...
- `millrace-blueprint-planning.md`: opt-in Blueprint Planning loop behavior, runtime effects, draft/packet/evaluation artifacts, closure suppression, and operator inspection.
