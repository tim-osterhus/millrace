...
def test_publish_workflow_smoke_checks_built_wheel_against_release_core_contract() -> None:
    ...
    expected_snippets = (
        ...
        'assert research_report_payload["status"] == "BLOCKED"',
        'assert research_report_payload["runtime"]["last_mode"] == "GOALSPEC"',
        'assert research_queue_payload["backlog_depth"] == 0',
        'assert research_supervisor_payload["attention_reason"] == "blocked_research"',
