...
- `assets/graphs/execution/standard.json` and
  ...
  override.
- `assets/modes/default_codex.json` and `assets/modes/learning_codex.json`:
...
- `assets/graphs/execution/standard.json`,
  ...
  `assets/modes/default_codex.json`, and
  `assets/modes/default_codex_integrated.json`: used by
