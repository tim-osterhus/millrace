...
The Flow graph DOM stays stable between unchanged poll responses so animated
lane effects continue smoothly while the rest of the read-only state refreshes.
