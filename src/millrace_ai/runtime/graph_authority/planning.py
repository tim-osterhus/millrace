"""Planning-plane compiled graph routing compatibility wrapper.
...
def route_planning_stage_result_from_graph(
    ...
    **kwargs: object,
    ...
    return route_generic_stage_result_from_graph(
        ...
        terminal_failure_class_fn=planning_terminal_failure_class,
...
def decision_from_planning_transition(
    ...
    *,
    ...
    that existing imports from ``.planning import decision_from_planning_transition``
    continue to work.
    """
    raise NotImplementedError(
        "decision_from_planning_transition is a legacy compatibility export. "
