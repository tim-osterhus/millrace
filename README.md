...
If you need the exact `v0.10.1` release, install `millrace-ai==0.10.1`.
...
For a version-pinned install of this release, use `python3 -m pip install millrace-ai==0.10.1`.
