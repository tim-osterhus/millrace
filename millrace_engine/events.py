...
class EventType(str, Enum):
    ...
    SENTINEL_ACKNOWLEDGED = "control.sentinel.acknowledged"
    SENTINEL_SOFT_CAP_TRIGGERED = "control.sentinel.soft_cap_triggered"
    SENTINEL_HARD_CAP_TRIGGERED = "control.sentinel.hard_cap_triggered"
    SENTINEL_NOTIFICATION_ATTEMPT_RECORDED = "control.sentinel.notification_attempt_recorded"
