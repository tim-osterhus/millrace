# Research Incident Mode

> Generated from the canonical JSON registry object. Edit the JSON file, not this companion.

- Kind: `mode`
- Canonical ID: `mode.research_incident`
- Version: `1.0.0`
- Tier: `default`
- Status: `active`
- Source Kind: `packaged_default`
- Source Ref: `registry/modes/mode.research_incident__1.0.0.json`
- Aliases: `incident`, `research-incident`
- Labels: `baseline`, `incident`, `mode`, `research`
- Extends: _none_
...
Packaged composed mode for incident-response research runs with the research.incident scaffold loop.
