...
- Canonical ID: `execution.large-execute`
- Version: `1.0.0`
- Tier: `default`
- Status: `active`
- Source Kind: `packaged_default`
- Source Ref: `registry/stages/execution.large-execute__1.0.0.json`
- Aliases: `large-execute`
...
Packaged LARGE execution stage registration for ordered thorough execution.
...
```json
{
  ...
  "context_schema_ref": "execution.large-execute.context.v1",
  "contract_version": "1.0.0",
  "handler_ref": "millrace_engine.stages.large_execute:Stage",
  ...
  "result_schema_ref": "execution.large-execute.result.v1",
  "retry_policy": {
    "backoff_seconds": 0.0,
