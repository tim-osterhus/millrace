...
- Canonical ID: `execution.builder`
- Version: `1.0.0`
- Tier: `default`
- Status: `active`
- Source Kind: `packaged_default`
- Source Ref: `registry/stages/execution.builder__1.0.0.json`
- Aliases: `builder`, `standard-builder`
...
Packaged builder stage registration for the standard execution path.
...
```json
{
  ...
  "context_schema_ref": "execution.builder.context.v1",
  "contract_version": "1.0.0",
  "handler_ref": "millrace_engine.stages.builder:Stage",
  ...
  "result_schema_ref": "execution.builder.result.v1",
  "retry_policy": {
    "backoff_seconds": 0.0,
