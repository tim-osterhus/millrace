...
- Canonical ID: `research.goal-intake`
- Version: `1.0.0`
- Tier: `default`
- Status: `active`
- Source Kind: `packaged_default`
- Source Ref: `registry/stages/research.goal-intake__1.0.0.json`
- Aliases: `goal-intake`, `goalspec-intake`
...
Packaged GoalSpec intake scaffold that turns one research request into a normalized brief.
...
```json
{
  ...
  "context_schema_ref": "research.goal_intake.context.v1",
  "contract_version": "1.0.0",
  "handler_ref": "millrace_engine.research.dispatcher:GoalIntakeStage",
  ...
  "result_schema_ref": "research.goal_intake.result.v1",
  "retry_policy": {
    "backoff_seconds": 5.0,
  ...
  "running_status": "GOAL_INTAKE_RUNNING",
  "success_statuses": [
    "GOALSPEC_RUNNING"
  ],
  "terminal_statuses": [
