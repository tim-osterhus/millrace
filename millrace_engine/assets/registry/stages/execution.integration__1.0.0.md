...
- Canonical ID: `execution.integration`
- Version: `1.0.0`
- Tier: `default`
- Status: `active`
- Source Kind: `packaged_default`
- Source Ref: `registry/stages/execution.integration__1.0.0.json`
- Aliases: `integration`
...
Packaged integration stage registration for the standard execution path.
...
```json
{
  ...
  "context_schema_ref": "execution.integration.context.v1",
  "contract_version": "1.0.0",
  "handler_ref": "millrace_engine.stages.integrate:Stage",
  ...
  "result_schema_ref": "execution.integration.result.v1",
  "retry_policy": {
    "backoff_seconds": 0.0,
