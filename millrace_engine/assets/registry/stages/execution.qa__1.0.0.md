...
- Canonical ID: `execution.qa`
- Version: `1.0.0`
- Tier: `default`
- Status: `active`
- Source Kind: `packaged_default`
- Source Ref: `registry/stages/execution.qa__1.0.0.json`
- Aliases: `qa`
...
Packaged QA stage registration for the standard execution path.
...
```json
{
  ...
  "context_schema_ref": "execution.qa.context.v1",
  "contract_version": "1.0.0",
  "handler_ref": "millrace_engine.stages.qa:Stage",
  ...
  "result_schema_ref": "execution.qa.result.v1",
  "retry_policy": {
    "backoff_seconds": 0.0,
