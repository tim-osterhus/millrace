...
- Canonical ID: `execution.troubleshoot`
- Version: `1.0.0`
- Tier: `default`
- Status: `active`
- Source Kind: `packaged_default`
- Source Ref: `registry/stages/execution.troubleshoot__1.0.0.json`
...
Packaged troubleshoot stage registration for the standard execution path.
...
```json
{
  ...
  "context_schema_ref": "execution.troubleshoot.context.v1",
  "contract_version": "1.0.0",
  "handler_ref": "millrace_engine.stages.troubleshoot:Stage",
  ...
  "result_schema_ref": "execution.troubleshoot.result.v1",
  "retry_policy": {
    "backoff_seconds": 0.0,
  ...
  "running_status": "TROUBLESHOOT_RUNNING",
  "success_statuses": [
    "TROUBLESHOOT_COMPLETE"
  ],
  "terminal_statuses": [
