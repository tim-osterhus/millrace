...
- Canonical ID: `execution.hotfix`
- Version: `1.0.0`
- Tier: `default`
- Status: `active`
- Source Kind: `packaged_default`
- Source Ref: `registry/stages/execution.hotfix__1.0.0.json`
- Aliases: `hotfix`
...
Packaged hotfix stage registration for the standard execution path.
...
```json
{
  ...
  "context_schema_ref": "execution.hotfix.context.v1",
  "contract_version": "1.0.0",
  "handler_ref": "millrace_engine.stages.hotfix:Stage",
  ...
  "result_schema_ref": "execution.hotfix.result.v1",
  "retry_policy": {
    "backoff_seconds": 0.0,
