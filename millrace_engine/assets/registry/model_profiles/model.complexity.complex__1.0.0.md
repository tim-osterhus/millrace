# Complex Complexity Model Profile

> Generated from the canonical JSON registry object. Edit the JSON file, not this companion.

- Kind: `model_profile`
- Canonical ID: `model.complexity.complex`
- Version: `1.0.0`
- Tier: `golden`
- Status: `active`
- Source Kind: `packaged_default`
- Source Ref: `registry/model_profiles/model.complexity.complex__1.0.0.json`
- Aliases: `complexity-complex`, `complex-routing`
- Labels: `complex`, `complexity`, `model`
- Extends: _none_
...
Packaged complex-band complexity-routing profile with real shipped Codex defaults.
