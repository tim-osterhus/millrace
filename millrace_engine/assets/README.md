...
If you need the exact `v0.6.2` release, install `millrace-ai==0.6.2`.
...
For a version-pinned install of this release, use `python3 -m pip install millrace-ai==0.6.2`.
