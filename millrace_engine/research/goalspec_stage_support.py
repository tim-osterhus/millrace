"""GoalSpec stage rendering and execution helpers."""
...
from ..contracts import ObjectiveContract, SpecInterviewPolicy
    ...
    *,
    ...
    if pending_question is not None:
        record = SpecInterviewRecord(
            ...
            question_path=_relative_path(paths.specs_questions_dir / f"{pending_question.question_id}.json", relative_to=paths.root),
            policy=policy,
    ...
    if resolved_question is not None:
        ...
        record = SpecInterviewRecord(
            ...
            title=source.title,
            source_path=_relative_path(queue_spec_path, relative_to=paths.root),
            question_path=_relative_path(paths.specs_questions_dir / f"{resolved_question.question_id}.json", relative_to=paths.root),
